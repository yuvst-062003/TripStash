  ...
  return (
    <div className="pad stack" style={{ paddingTop: 'var(--s-4)' }}>
      ...
      {!progress && !plan && !results && (
        <>
          <button className="btn btn--ink btn--block" onClick={() => inputRef.current?.click()}>
      ...
      {progress && (
        <div className="stack-2">
          ...
          <p className="t-small dimmer num">
        ...
        <div className="stack">
          <div>
            <p className="t-title num">
              {plan.fresh.length}
              <span className="t dimmer"> new</span>
            </p>
            <p className="meta">
          ...
          {plan.fresh.length === 0 ? (
            ...
            <button className="btn btn--ink btn--block" onClick={importFresh}>
      ...
      {results && !progress && (
        <div className="stack">
          ...
          <button className="btn btn--ink btn--block" onClick={onDone}>
            Done
          </button>
        </div>
      )}
