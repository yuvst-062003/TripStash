  ...
  return (
    <div className="screen">
      <header className="topbar">
        <h1 className="t-lg grow">Shared to TripStash</h1>
      </header>

      <div className="pad">
        {!result && !error && (
          <>
            <p className="t-sm dim">{note}</p>
        ...
        {result && (
          <div className="stack">
            ...
            <div>
              <p className="t-md clamp-2">{result.title || result.url}</p>
              {result.url && (
            ...
            <div className="row" style={{ gap: 'var(--s-2)' }}>
              <Link className="btn btn--accent grow" to="/saved">
