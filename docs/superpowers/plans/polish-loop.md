...
| 4 | Saved (tabs) | done | A 8 / B 4 / C 8 → 18 applied, 2 skipped (API failure copy; drop Places tab) | (this commit) |
| 5 | Inbox review card | done | A 8 / B 4 / C 8 → 18 applied, 2 skipped (Ignore undo endpoint; stagger cap in MotionRow) | (this commit) |
| 6 | Place | pending | | |
| 7 | Trip | pending | | |
| 8 | Journey | pending | | |
